<template>
  <section
    class="relative w-full h-[500px] bg-no-repeat bg-cover bg-bottom"
    style="background-image: url('/hero_bg.svg')"
  >
    <div class="absolute inset-0 flex items-center justify-center">
      <div class="text-center ml-8">
        ...
        <p class="mt-4 text-lg text-gray-700">
          Notre magasin propose un vaste choix de VHS classiques, cultes et rares. Venez rencontrer
          nos experts qui sauront vous conseiller pour dénicher la perle rare pour votre soirée
          cinéma.
        </p>
