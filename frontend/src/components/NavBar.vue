      ...
      <div class="flex items-center space-x-4">
        ...
        <router-link to="/utilisateur">
          <ButtonRetro class="flex items-center space-x-2  px-4 py-2 rounded">
            <svg class="w-6 h-6 text-black-50" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h18M3 3l3 18h12L21 3M3 3l4 4M17 7l4 4M5 19h14"></path>
            </svg>
...
<script>
import { useStore } from 'vuex'; // Assure-toi d'importer useStore depuis Vuex
...
export default defineComponent({
  ...
  methods: {
    logOutAccount() {
      this.toast.success("Au revoir " + this.userName + " !", { toastClassName: "bg-trempanilloVert font-bold" });
      this.logOut();
    }
  }
});
